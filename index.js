...
const createSmartContract = () => {
    return new Promise(resolve => {
        if (appName) {
            ...
            await cdIntoNewApp();
            shell.exec(`truffle unbox metacoin`, () => {
...
const installPackages = () => {
    return new Promise(resolve => {
        ...
        shell.exec(`npm install --save hardhat @openzeppelin/contracts @truffle/hdwallet-provider chai solidity-docgen truffle @nomiclabs/hardhat-ethers @nomiclabs/hardhat-truffle5 @nomiclabs/hardhat-waffle @nomiclabs/hardhat-web3 eth-gas-reporter ethereum-waffle ethers mocha prettier prettier-plugin-solidity solc-0.7 solidity-coverage truffle-assertions web3`, () => {
